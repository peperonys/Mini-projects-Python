...
#запускать в колабе https://colab.research.google.com/drive/1MKZRtONEAYLmXZkHsMHvFs4iQRNirsdH?usp=sharing
import numpy as np
...
learning_rate = 0.1
epochs = 500 #50 достаточно так как лос не уменьшается дальше
